...
if __name__ == '__main__':
    # Comment out the call to the UE4 prereqs installer in Setup.bat, since we done that and this breaks things.
    ...
    # Also comment out the version selector call, since we do this later as well.
    SELECTOR_CALL = (
